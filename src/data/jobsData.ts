...
const senseRole: Role = {
  ...
  dateStart: new Date('September, 2022'),
  dateEnd: new Date('September, 2024'),
  details: [
...
const cognexNPIRole: Role = {
  ...
  dateStart: new Date('February, 2021'),
  dateEnd: new Date('September, 2022'),
  details: [
...
const cognexSustainingRole: Role = {
  ...
  dateStart: new Date('May, 2018'),
  dateEnd: new Date('February, 2021'),
  details: [
...
export const jobsData: Job[] = [
  ...
  },
  {
    ...
    logo: '/src/assets/CognexLogo.jpg',
